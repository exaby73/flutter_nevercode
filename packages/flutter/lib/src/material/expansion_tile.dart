...
class ExpansionTile extends StatefulWidget {
  ...
  /// is also null and [ThemeData.useMaterial3] is true, [ColorScheme.onSurface] is used from the
  /// [ListTile] widget. Otherwise, defaults to [ThemeData.unselectedWidgetColor] color.
  ///
  /// See also:
  ///
  /// * [ExpansionTileTheme.of], which returns the nearest [ExpansionTileTheme]'s
  ...
  /// is also null and [ThemeData.useMaterial3] is true, color of the [TextTheme.bodyLarge]
  /// will be used for the [title] and color of the [TextTheme.bodyMedium] will be used for the
  /// [subtitle]. Otherwise, defaults to color of the [TextTheme.titleMedium].
  ///
  /// See also:
  ///
  /// * [ExpansionTileTheme.of], which returns the nearest [ExpansionTileTheme]'s
